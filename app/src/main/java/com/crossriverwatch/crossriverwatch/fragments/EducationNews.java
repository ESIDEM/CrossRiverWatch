 ...
 */
public class EducationNews extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = "EducationNews";
    ...
    private int mCatId = 4; // Category ID
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        catTextView.setText("Education News");
        ...
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.VALUE, "open Education News ");
