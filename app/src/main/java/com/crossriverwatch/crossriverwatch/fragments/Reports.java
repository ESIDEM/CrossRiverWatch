 ...
 */
public class Reports extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private int mCatId = 5; // Category ID
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.VALUE, "open Reports ");
