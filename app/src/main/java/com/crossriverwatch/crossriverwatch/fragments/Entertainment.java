...
public class Entertainment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private int mCatId = 398; // Category ID
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        catTextView.setText("Entertainment News");
        ...
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.VALUE, "open Entertainment News ");
