...
public class PoliticsNews extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = "PoliticsNews";
    ...
    private int mCatId = 3; // Category ID
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        catTextView.setText("Politics News");
        ...
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.VALUE, "open Political News ");
