...
public class HealthNews extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private int mCatId = 397; // Category ID
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        catTextView.setText("Health News");
        ...
        Bundle bundle = new Bundle();
        bundle.putString(FirebaseAnalytics.Param.VALUE, "open Health News ");
