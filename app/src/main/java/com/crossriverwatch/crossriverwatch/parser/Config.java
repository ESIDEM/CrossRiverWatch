...
public class Config  {
    ...
    public static String BASE_URL = "http://crossriverwatch.com/";



    public static  String NEW_CATEGORY = "?json=get_posts&page=";

    public static final String NEW_URL = "http://crossriverwatch.com/api/get_recent_posts/";
